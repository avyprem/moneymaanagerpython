...
def data():
  total_expenses = float(Q1_entry.get()) + float(Q2_entry.get()) + float(Q3_entry.get()) + float(Q4_entry.get()) + float(Q5_entry.get()) + float(Q6_entry.get()) + float(Q8_entry.get()) + float(Q9_entry.get()) + float(Q10_entry.get()) +  float(Q11_entry.get()) + float(Q12_entry.get())
  
  remaining = float(monthly_income.get()) - total_expenses
  
  data = [Q1_entry.get(), Q2_entry.get(), Q3_entry.get(), Q4_entry.get(), Q5_entry.get(), Q6_entry.get(), Q8_entry.get(), Q9_entry.get(), Q10_entry.get(), Q11_entry.get(), Q12_entry.get(), remaining]
  plt.figure(figsize=(6,6))

  labels = ['Mortgage', 'Insurance', 'Communications','Car', 'Education', 'Debt', 'Investing', 'Clothing', 'Personal', 'Groceries', 'Pets', 'Remaining']
...
Q12_label = tkinter.Label(other, text="(12) How Much Do You Spend on Pets? (Veterinarian Clinic Visits, Food)")
